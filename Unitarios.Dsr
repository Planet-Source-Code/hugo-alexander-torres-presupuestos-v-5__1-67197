VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} Unitarios 
   Bindings        =   "Unitarios.dsx":0000
   Caption         =   "Presup Ver. 5.0  Módulo Impresión de Análisis Unitarios"
   ClientHeight    =   6495
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10485
   Icon            =   "Unitarios.dsx":001F
   ...
   BeginProperty Section6 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   255
         Object.Caption         =   $"Unitarios.dsx":44FF
      EndProperty
      ItemType1       =   3
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
