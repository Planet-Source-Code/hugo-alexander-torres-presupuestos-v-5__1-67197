VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ManObra 
   Bindings        =   "ManObra.dsx":0000
   Caption         =   "Presup Ver. 5.0  Módulo Impresión de Mano de Obra"
   ClientHeight    =   4035
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10065
   Icon            =   "ManObra.dsx":001F
   MinButton       =   0   'False
   ...
   TopMargin       =   1200
   BottomMargin    =   1200
   Title           =   "LISTADO DE MANO DE OBRA EN LA BASE"
   DataMember      =   "Command2"
   NumSections     =   3
   SectionCode0    =   2
