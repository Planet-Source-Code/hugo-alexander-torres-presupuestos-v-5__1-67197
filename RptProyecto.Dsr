VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} RptProyecto 
   Caption         =   "Información General del Proyecto"
   ClientHeight    =   6045
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7830
   Icon            =   "RptProyecto.dsx":0000
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   12582912
         Object.Caption         =   "Informe de Datos Generales"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   4
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         ForeColor       =   16711680
         BackColor       =   14737632
         Object.Caption         =   "Impreso:"
      EndProperty
   EndProperty
End
Attribute VB_Name = "RptProyecto"
...
' --------------------------
' En el datareport Realizo una consulta irrelevante
' con el fin de "despistar" la peticion de fuente de datos
' del DataReport, puesto que no necesito.
' Los valores de los campos del DataReport los envio
' desde el formulario en forma directa(Sin Conexion a Datos).
' Oliver Toro - 2002
' --------------------------
Option Explicit
...
Private Sub DataReport_Initialize()
     Call AbreConexion(cn, tAccess, adUseClient)
     
     ' Abrir una conexion con NADA, para permitir pasar
     rs.Open "select 1", cn
