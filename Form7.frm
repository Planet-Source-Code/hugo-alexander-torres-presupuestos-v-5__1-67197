...
Begin VB.Form Form7 
   ...
   Caption         =   "Presup Ver. 5.0   Edición/Creación de Materiales"
   ClientHeight    =   4500
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5910
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":0E2A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":0F8A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":10E6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":1242
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":139E
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":14FA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":1A96
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":2032
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":25CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":2B6A
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Form7.frx":3112
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub CmdConectar_Click()
     ...
     If AbreConexion(gConexion, tAccess, adUseClient) Then
          ...
          gRsINSUMOS.Open "SELECT * FROM INSUMOS WHERE CLAVE= 'MAT'ORDER BY id", gConexion, adOpenStatic, adLockOptimistic
          Screen.MousePointer = vbDefault
          If gRsINSUMOS.RecordCount > 0 Then
               gRsINSUMOS.MoveFirst
               StatusBar1.Panels(1).Text = " Identificador de Materiales en uso : " & gRsINSUMOS.RecordCount
               Call CargarDatos
          Else
     ...
     Select Case Button.key
          ...
          Case "grabar":
               ...
               If sModo = "Nuevo" Then
                    ...
                    sSQl = "INSERT INTO INSUMOS(ID, COD_INSUMO, CLAVE, INSUMO, UN_INSUMO, AJUSTE_MAT, AJUSTE_EQP, AJUSTE_MDO, VALOR, PROVEEDOR, OBSERVACIONES) " & _
                           "VALUES " & _
                           "(" & txtidentificador.Text & ",'" & txtcodigo.Text & "','" & txtClave.Text & "','" & txtnombre.Text & "','" & txtunidad.Text & "','" & AJMAT & "','" & AJEQP & "','" & AJMDO & "','" & txtvalor.Text & "','" & txtproveedor.Text & "','" & txtobservacion.Text & "')"
        ...
        Case "imprimir"
               ' Asignar los valores a los controles de la seccion
                DataEnvironment1.Commands("Command2").CommandText = "INSUMOS WHERE CLAVE= 'MAT'ORDER BY id"
                materiales.Show
